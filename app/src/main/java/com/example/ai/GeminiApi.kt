...
suspend fun askGemini(prompt: String): String = withContext(Dispatchers.IO) {
    ...
    val request = GenerateContentRequest(
        systemInstruction = Content(
            parts = listOf(Part(text = "You are a helpful AI assistant for the Pagges Chat and Wallet app. Users can ask you questions about their activity, chat, or balance. Keep answers concise."))
        ),
